...
## Background
In 2018-2019 Minds Matter Seattle’s board decided to undertake a project to improve knowledge management throughout the organization in order to make information more accessible better preserve and spread institutional knowledge throughout the turnover of volunteers.  At the core of this need is the ability to share information easily, but also securely throughout the organization.  Relatedly, a large overhead was being spent in maintaining and curating email lists for communication, while using google’s gsuite tools to share information between volunteers, students, ec members and board members. 


Although some organization members had minds matter accounts others did not and this ad hoc use of sharing permissions made it difficult to maintain access to the appropriate information as new volunteers entered roles.  Often key documents were owned and shared via volunteer’s personal gmail account.  A lot of time was being spent asking where certain pieces of information were being held and how people could get access to them.  This represented a long term liability for the organization.

The board and EC evaluated a number of options, but ultimately decided that google’s gsuite services fit the organization overall needs and would minimize the institutional disruption, as several of the services (drive, classroom, groups) were already being utilized by the org.  If every Minds Matter community member had their own account, and a backend system could maintain membership in the organization and appropriate google groups, then permissions could be easily managed through the use of group sharing.  Furthermore, google sites could be utilized to provide an easy to edit Intranet site that could be shared privately with only the appropriate members of the org. 
...
3. Setup a salesforce report that includes all the volunteers and students you want to have accounts.  We setup our up as follows 
